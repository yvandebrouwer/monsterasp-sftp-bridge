...
Het back-upsysteem bestaat uit twee hoofdcomponenten:
...
Cron-job.org vervangt eerdere Google Apps Script triggers.
...
Cron-job.org doet soms retries bij cold starts → de Bridge-app filtert
duplicaten.
...
➡️ **Geen dubbele mails**, ook niet bij meerdere webhook-calls.
